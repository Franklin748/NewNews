      ...
      <footer>
        <div className='footer'>
            ...
            <ul className='contato'>
                <li>Contato:</li>
                <li><img className='icon-imagem' src={icon3} alt="Instagram" /></li>
                <li><img className='icon-imagem' src={icon1} alt="Twitter" /></li>
                <li><img className='icon-imagem' src={icon2} alt="Facebook" /> </li>
            </ul>
